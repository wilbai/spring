        ...
        <section class="content">
            <div class="box">
                ...
                <div class="box-footer">
                    <span style="color: #ccc" class="pull-right" title="<fmt:formatDate value="${saleChance.createTime}"/>">
                        创建日期：<fmt:formatDate value="${saleChance.createTime}" pattern="yyyy年MM月dd日 HH:mm"/>
                    </span>
                </div>
            </div>
                            ...
                            <c:choose>
                                <c:when test="${record.content == '将当前进度修改为: [成交]'}">
                                    <li>
                                        ...
                                        <div class="timeline-item" title="<fmt:formatDate value="${record.createTime}" pattern="yyyy-mm-dd HH:mm"/>">
                ...
                <div class="col-md-4">
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools">
                                <a href="/task/new?saleId=${saleChance.id}" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> 新增任务</a>
                            </div>
                        </div>
                        <div class="box-body">
    ...
    $(function () {
        ...
        $("#delBtn").click(function () {
            layer.confirm("确定要删除么?", function () {
                window.location.href = "/sales/my/"+saleId+"/delete";
            });
        });
